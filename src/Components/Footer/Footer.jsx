...
const Footer = () => {
  ...
  // Gets create a rect hook to add a scroll animation...
  useEffect( () => {
        ...
        <div className="footerCard flex">
          ...
          <div className="footerIntro flex">
            ...
            <div data-aos="fade-up" className='footerParagraph'>
              Lorem ipsum dolor sit amet consectetur adipisicing elit. Quibusdam porro ipsam reiciendis minima! Fugiat nisi alias vero officiis voluptatum, est quam deserunt, quaerat at architecto, laborum quidem enim neque sunt.
            </div>
          ...
          <div className="footerLinks grid">
            ...
            <div data-aos="fade-up"  data-aos-duration="5000" className="linkGroup">
             ...
             <div data-aos="fade-up" data-aos-duration="5000" className="linkGroup">
              ...
              <li className="footerList flex">
                <FiChevronRight className="icon" /> Rentcats
              </li>
              ...
              <li className="footerList flex">
                <FiChevronRight className="icon" /> TripAdvinsor
              </li>
            </div>
