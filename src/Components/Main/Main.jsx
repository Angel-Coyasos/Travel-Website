  ...
  return (
    <section className='main container section'>
      ...
      <div className="secContent grid">
        {/* so guys, here we are going to use high order array method(map). To do that shall use a list of object in one array. I'm going to create an array named data and from that we shall .map() array to fetch each destination at once. i hope this will make sence to you!*/}
